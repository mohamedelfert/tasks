                    ...
                    <div class="col-md-12 mt-2">
                        <div class="card bg-light">
                            <div class="card-header">
                                <h5 class="card-title text-center"><span class="badge-pill badge-lg badge-primary">Title</span> : {{$task->title}}</h5>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <p class="card-title text-center">
                                    <span class="badge-pill badge-lg badge-secondary">Description</span> : {{$task->description}}
                                </p>
                            </div>
                        </div>
                    </div>
