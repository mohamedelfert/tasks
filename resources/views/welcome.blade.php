...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ $title ?? "Title" }}</h2>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale" data-toggle="modal" href="#add" title="@lang('main.create')">
                        ...
                        <div class="col-md-3 mt-2">
                            <div class="card bg-light">
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('tasks.show',$task->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal" href="#delete{{$task->id}}" title="@lang('main.delete')">
                                ...
                                <div class="modal-content modal-content-demo">
                                    ...
                                    <form action="{{ route('tasks.destroy', $task->id) }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input class="form-control" name="title" id="title" value="{{$task->title}}" type="text" readonly>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('main.cancel')
                                            </button>
                                ...
                                <form action="{{ route('tasks.store') }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" name="description" id="description" type="text" class="form-control" placeholder="Add a Description" required></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('main.cancel')
